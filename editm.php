...
$result=mysqli_query($con,"select * from movement where id='$x'");
	...
	<div class="alert alert-warning">
		...
		<div class="row">
			...
			<div class="panel-heading">
				<h1 class="text-center text-uppercase">Edit  Movement </h1>
			</div>

			<div class="panel-body">
		<form action="editm.php?fadi=<?php echo $x; ?>" method="post">
...
if(isset($_POST['btn']))
{
	...
	movement set name='$name' ,dt='$dt',reason='$reason' where id='$x'");
	if(isset($res))
	{
		echo'
		<script> alert("Edit movement Successfully");</script>
		';
	}

	else{
	echo'
		<script> alert("Edit movement failed.. Try Again");</script>
		';
}
}
ob_end_flush();
