...
<label >Number Of Days :</label>
		...
		<input type="text" class="form-control" name="sd"><br>

<label >End Date :</label>

		<input type="text" class="form-control" name="ed"><br>
...
{
$res22=mysqli_query($con,"insert into 
	vac(name,total,taked,remin)
	values('$name','30','0','30')");
}
$r12=mysqli_query($con,"select * from vac where name='$name'");
$tr=mysqli_fetch_array($r12);
...
$res=mysqli_query($con,"insert into 
	...
	values('$name','30','$num','$tt','$sd','$ed','$type')");

$qq1=mysqli_query($con,"update vac set remin='$tt',taked='$take' where name='$name'");
	$qq=mysqli_query($con,"update vacation set remin='$tt' where name='$name'");
	if(isset($res))
	{
		echo'
