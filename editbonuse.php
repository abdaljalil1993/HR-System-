...
$result=mysqli_query($con,"select * from bonuse where id='$x'");
...
<div class="container">
	<div class="alert alert-warning">
			<h3 class="text-center"><i class="fa fa-dollar"></i>Edit Employee Bonuse </h3>
		</div>
		...
		<div class="row">
			...
			<div class="panel-heading">
				<h1 class="text-center text-uppercase">Edit Data  </h1>
			</div>

			<div class="panel-body">
		<form action="editbonuse.php?fadi=<?php echo $x; ?>" method="post">
		<label >Employee Name :</label>
					<select name="n" value="<?php echo $rr['name']; ?>" class="form-control">
						<?php
						include'conn.php';
...
if(isset($_POST['btn']))
{
	...
	bonuse set name='$name',dt='$dt',reason='$reason',amount='$amount' where id='$x'
	");
	if(isset($res))
	{
		echo'
		<script> alert("Edit Bonuse Successfully");</script>
		';
	}

	else{
	echo'
		<script> alert("Edit Bonuse failed.. Try Again");</script>
		';
}
}
ob_end_flush();
