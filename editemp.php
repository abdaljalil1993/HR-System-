		...
		<div class="col-md-6 mr-4">
			<div class="panel panel-warning">
				<div class="panel-body">
					...
					<input value="<?php echo $rr['dob']; ?>" type="text" class="form-control" name="dob"><br>

					<label >Date Of Join :</label>
					<input value="<?php echo $rr['doj']; ?>" type="text" class="form-control" name="doj"><br>

					<label >Start Date :</label>
					<input value="<?php echo $rr['sd']; ?>" type="text" class="form-control" name="sd"><br>

					<label >End Date :</label>
					<input value="<?php echo $rr['ed']; ?>" type="text" class="form-control" name="ed"><br>

					<label >Viza End Date :</label>
					<input value="<?php echo $rr['vd']; ?>" type="text" class="form-control" name="vd"><br>
...
if(isset($_POST['btn']))
{
	...
	{
		echo'
		<script> alert("Edit Employee Successfully");</script>
		';
	...
	echo'
		<script> alert("Edit Employee Failed Try Again");</script>
		';
}
}
?>
